...
export function activate(context: vscode.ExtensionContext): void {
  context.subscriptions.push(
    vscode.commands.registerCommand("unomvvmexpress.createApp", () => runCreateApp()),
    vscode.commands.registerCommand("unomvvmexpress.addPage", () => runAddPage()),
  );
}
...
async function runCreateApp(): Promise<void> {
  try {
    ...
    const folder = await vscode.window.showOpenDialog({
      ...
      title: "Uno MVVMExpress app folder",
    });
...
async function runAddPage(): Promise<void> {
  try {
    ...
    const folder = await vscode.window.showOpenDialog({
      ...
      title: "Uno MVVMExpress page folder",
    });
