...
{
    public const string PackageId = "Plugin.Uno.MVVMExpress.Templates";
    public const string PackageVersion = "1.0.0";
    public const string AppShortName = "uno-mvvmexpress";
    public const string PageShortName = "uno-mvvmexpress-page";
    ...
    public static async Task CreateAppAsync(string name, string outputDir, CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidOperationException("Could not create the Uno MVVMExpress app." + Environment.NewLine + result.Combined);
        }
    }
    ...
    public static async Task AddPageAsync(string name, string namespaceName, string outputDir, CancellationToken cancellationToken)
    {
        ...
        if (result.ExitCode != 0)
        {
            throw new InvalidOperationException("Could not add the Uno MVVMExpress page." + Environment.NewLine + result.Combined);
        }
    }
