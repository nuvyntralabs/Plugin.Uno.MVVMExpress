...
namespace Plugin.Uno.MVVMExpress.Core.Tests.Forms;
...
public sealed class FormFieldAndSubmitTests
{
    ...
    private sealed class ConfirmForm : FormViewModel
    {
        ...
        public Task<Plugin.Uno.MVVMExpress.Outcome.Outcome> RunSubmitAsync()
            => SubmitAsync(_ => Task.FromResult(Plugin.Uno.MVVMExpress.Outcome.Outcome.Success()));
