...
using Plugin.Uno.MVVMExpress.Validation;

namespace Plugin.Uno.MVVMExpress.Validation.Tests;
...
public sealed class DataAnnotationsValidatorTests
{
    ...
    {
        Assert.Equal("Plugin.Uno.MVVMExpress.Validation", ValidationMarker.PackageId);
    }
