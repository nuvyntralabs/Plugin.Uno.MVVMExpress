...
Independent Uno Platform MVVM family. **1.0.0.** Aligned with the Plugin.Maui.MVVMExpress 1.3 / Plugin.Wpf.MVVMExpress 1.0 Core contract, but **not** a package reference to those families.
