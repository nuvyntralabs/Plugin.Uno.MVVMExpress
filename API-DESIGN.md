...
**1.0.0** contract. Namespaces start with `Plugin.Uno.MVVMExpress`. Core shapes match Maui 1.3 / WPF 1.0 so a ViewModel ports with a namespace swap. This is **not** a type-forward of sibling families.
